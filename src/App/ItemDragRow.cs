...
public sealed partial class ItemDragRow : ActivatableRow
{
	...
	public override Variant _GetDragData(Vector2 atPosition)
	{
		...
		{
			Text = "→ " + (GameDataProvider.Shared.Item(ItemKey)?["n"]?.GetValue<string>() ?? ItemKey)
		};
